...
#define MAKE_MY_DEF_STR(x) #x
#define MAKE_MY_CONCAT(x, y) x##y
#define YAML_VERSION_STRING MAKE_MY_CONCAT(MAKE_MY_DEF_STR(YAML_VERSION_MAJOR), MAKE_MY_CONCAT(MAKE_MY_DEF_STR(YAML_VERSION_MINOR), MAKE_MY_DEF_STR(YAML_VERSION_PATCH)))
